...
class SelfMessages {
  ...
  start() {
    // Cache the userstore module as a variable
    this.currentUserModule = BdApi.Webpack.getModule((m) => m?._dispatchToken && m.getCurrentUser);
  ...
  getCurrentUser() {
    return this.currentUserModule?.getCurrentUser?.(); // Access the cached userstore module
  }
